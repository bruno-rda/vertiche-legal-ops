  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Editar Tienda">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-text-primary mb-1">Nombre de la tienda</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-10 px-3 bg-surface border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent"
            />
            {errors.municipio && <p className="text-xs text-danger mt-1">{errors.municipio.message}</p>}
          </div>
        </div>

        <div>
          <label className="block text-sm font-medium text-text-primary mb-1">Dirección completa</label>
          <textarea
          ...
          />
          {errors.direccion && <p className="text-xs text-danger mt-1">{errors.direccion.message}</p>}
        </div>
