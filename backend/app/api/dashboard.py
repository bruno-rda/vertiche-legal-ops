...
from app.schemas.dashboard import CumplimientoEstado, DashboardMetrics
from app.schemas.tramite import Tramite
...
@router.get("/cumplimiento-por-estado", response_model=list[CumplimientoEstado])
...
@router.get("/alertas-recientes", response_model=list[Alerta])
...
@router.get("/tramites-proximos", response_model=list[Tramite])
